...
function translate(input) {
	if (input === "&&" || input === "and" || input === "\u2227" || input === "\\land" || input === "\\wedge" || input === "^" || input === "*")
		return "/\\";	/*↑此处列表增加[|| input === "*"]*/
	if (input === "||" || input === "or" || input === "\u2228" || input === "\\lor" || input === "\\vee" || input === "+")
		return "\\/";	/*↑此处列表增加[|| input === "+"*/
	if (input === "=>" || input === "\u2192" || input === "implies" || input === "\\to" || input === "\\rightarrow" || input === "\\Rightarrow")
		return "->";
	if (input === "<=>" || input === "\u2194" || input === "iff" || input === "\\leftrightarrow" || input === "\\Leftrightarrow")
		return "<->";
	if (input === "not" || input === "!" || input === "\u00AC" || input === "\\lnot" || input === "\\neg"|| input === "\-")
		return "~";		/*↑此处列表增加[|| input === "\-"*/
	if (input === "\u22A4" || input === "true" || input === "\\top")
		return "T";
